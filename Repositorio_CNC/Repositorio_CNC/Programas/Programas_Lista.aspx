<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Programas_Lista.aspx.cs" Inherits="Repositorio_CNC.Programas.Programas_Lista" %>
        ...
        <div class="row bg-light">
            <div class="col-12">
                <asp:GridView
                    ...
                    OnPageIndexChanging="GridProgramas_PageIndexChanging" AutoGenerateEditButton="True" OnRowEditing="GridProgramas_RowEditing">
                    <Columns>
