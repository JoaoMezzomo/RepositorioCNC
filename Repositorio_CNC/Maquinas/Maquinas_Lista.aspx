...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container bg-secondary">
        ...
        <div class="row py-2 bg-secondary">
            ...
            <div class="col-sm-12 col-md-12 col-lg-3 col-xl-3 pt-1 pt-sm-1 pt-md-1 pt-lg-0 pt-xl-0 pr-3 pr-sm-3 pr-md-3 pr-lg-1 pr-xl-1">
                <asp:TextBox class="form-control" placeholder="Número" style="width:100%;" ID="txtNumero" runat="server"></asp:TextBox>
            </div>
            <div class="col-sm-12 col-md-12 col-lg-3 col-xl-3 pt-1 pt-sm-1 pt-md-1 pt-lg-0 pt-xl-0 pr-3 pr-sm-3 pr-md-3 pr-lg-1 pr-xl-1">
                <asp:DropDownList class="form-control" placeholder="Número" style="width:100%;" ID="ddlTipo" runat="server"></asp:DropDownList>
            </div>
